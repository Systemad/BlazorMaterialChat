...
namespace BlazorMaterialChat.Server.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Register(RegisterRequest paramaters)
        {
            var user = new ApplicationUser();
            user.UserName = paramaters.UserName;

            var result = await _userManager.CreateAsync(user, paramaters.Password);
